...
class WatsonService:
    ...
    DEFAULT_PROJECT_ID = "428f070b-99f6-4901-88e7-069b61616020"
...
Prioritize by impact and effort. Format as JSON array of suggestions."""
    ...
    def _call_watson_api(self, prompt: str, token: str) -> Optional[AIAnalysisResult]:
        """
        Call Watson chat API with the given prompt.
        ...
        try:
            ...
            if response.status_code != 200:
                logger.error(f"Watson API non-200 response: {response.text}")
                return None
